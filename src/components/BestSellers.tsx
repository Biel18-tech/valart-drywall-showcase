        ...
        {products.map((p, i) => (
          ...
          >
            ...
            <div className="p-3 flex flex-col flex-1">
              ...
              <button className="mt-3 w-full bg-red-brand hover:bg-red-brand-hover text-accent-foreground text-xs font-heading font-bold py-2.5 rounded-lg flex items-center justify-center gap-1.5 transition-colors">
