    ...
    <div className="absolute inset-0 flex items-center">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <a
            href="#"
            className="inline-block bg-red-brand hover:bg-red-brand-hover text-accent-foreground font-heading font-bold text-lg px-8 py-4 rounded-lg transition-colors shadow-lg"
          >
